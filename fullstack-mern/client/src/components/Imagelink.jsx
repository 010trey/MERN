...
function ImageLink() {
 ...
 const imageUrl = ''; // Replace with your image path or URL
  const linkUrl = 'https://google.com'; // Replace with the URL you want to link to
  ...
  return (
    ...
    <div className="image-container">
        <div className='box'>
          <br/>
        <img src={"./public/image/download.jpeg"} alt="Clickable Image" />
                        <h3>Subject:Math</h3>
        </div>
        <div className='box'>
        <img src={"./public/image/download (2).jpeg"} alt="Clickable Image" />
                        <h3>Subject:Biology</h3>
        </div>
        <div className='box'>
          <br/>
        <img src={"./public/image/download (12).jpeg"} alt="Clickable Image" />
                        <h3>Subject:Physic</h3>
        </div>
      </div>
      ...
      <div className="image-container">
        <div className='box'>
          <br/>
        <img src={"./public/image/download (16).jpeg"} alt="Clickable Image" />
                                <h3>Subject:Geography</h3>
        </div>
        <div className='box'>
        <img src={"./public/image/download (21).jpeg"} alt="Clickable Image" />
                              <h3>Subject:History</h3>
        </div>
        <div className='box'>
          <br/>
        <img src={"./public/image/download (7).jpeg"} alt="Clickable Image" />
                              <h3>Subject:Chemistry</h3>
        </div>
      </div>
    </a>
    </div>
